	DE0_LT24_SOPC u0 (
		...
		.lt_avalon_out_cs                            (<connected-to-lt_avalon_out_cs>),                            //                        lt_avalon_out.cs
		.lt_avalon_out_sdi                           (<connected-to-lt_avalon_out_sdi>),                           //                                     .sdi
		.lt_avalon_out_sdo                           (<connected-to-lt_avalon_out_sdo>),                           //                                     .sdo
		.lt_avalon_out_sclk                          (<connected-to-lt_avalon_out_sclk>),                          //                                     .sclk
		.lt_avalon_out_sint                          (<connected-to-lt_avalon_out_sint>),                          //                                     .sint
